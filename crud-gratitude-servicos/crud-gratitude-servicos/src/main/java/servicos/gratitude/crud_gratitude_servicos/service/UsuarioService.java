...
import servicos.gratitude.crud_gratitude_servicos.mapper.UsuarioAutenticationMapper;
...
//    private UsuarioRepository usuarioRepository;
    ...
    public UsuarioTokenDto autenticar(Usuario usuario){
        ...
        return UsuarioAutenticationMapper.of(usuarioAutenticado, token);
    }
    ...
    public List<UsuarioListarDto> listarTodos(){
        ...
        return usuariosEncontrados.stream().map(UsuarioAutenticationMapper::of).toList();
    }
